#!/usr/bin/env python3
"""
Test runner for gen_table microservice - Test002

This test uses nested structure (S3 CORS configuration)
"""
...
def main():
    ...
    with open('output.html', 'w', encoding='utf-8') as f:
        ...
        f.write('  <title>Test002 - S3 CORS Configuration (Nested)</title>\n')
        f.write('  <style>\n')
        ...
        f.write('</head>\n')
        f.write('<body>\n')
        f.write('  <h1>Test002 - S3 CORS Configuration (Nested)</h1>\n')
        f.write('  <h2>aws_s3_bucket_cors_configuration.example</h2>\n')
        f.write(html)
        f.write('\n</body>\n')
        f.write('</html>\n')
